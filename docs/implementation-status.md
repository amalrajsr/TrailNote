...
| W08 — own content, reports, contacts and moderation  | In progress | `/me`, author edit/delete, progressive contact reveal/removal, reports, open/resolved moderation views and history, confirmed hide/suspend plus restore controls, conflict-safe actions, support scripts, policy pages; 20 database integration tests | Account-erasure's real ImageKit delete/purge requires provider credentials and was not invoked; screenshots were omitted by request |
