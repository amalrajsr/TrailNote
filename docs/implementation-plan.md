...
| `username_claims` | case-insensitive unique username; nullable userId FK set null on account deletion; createdAt. Claims remain reserved after rename or deletion |
